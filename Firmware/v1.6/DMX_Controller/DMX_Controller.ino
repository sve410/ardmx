...
// **																														**
// **	Este programa es software libre: usted puede redistribuirlo y / o modificarlo bajo los tÃ©rminos de la 				**
// **	Licencia PÃºblica General GNU publicada por la Free Software Foundation, bien de la versiÃ³n 3 de la Licencia, 		**
// **	o (A su elecciÃ³n) cualquier versiÃ³n posterior.																		**
// **																														**
// **Â Â Â Este programa se distribuye con la esperanza de que sea Ãºtil, pero SIN NINGUNA GARANTÃ�A; ni siquiera la garantÃ­a 	**
// **	implÃ­cita de COMERCIALIZACIÃ“N o IDONEIDAD PARA UN PROPÃ“SITO PARTICULAR. Vea el GNU General Public License 			**
// **	para mÃ¡s detalles.																									**
// **																														**
// ** 	Esto es software libre, y le invitamos a redistribuirlo bajo ciertas condiciones									**
// **																														**
// **Â Â Â DeberÃ­a haber recibido una copia de la Licencia PÃºblica General GNU													**
// **Â Â Â junto con este programa. Si no es asÃ­, consulte <http://www.gnu.org/licenses/>.										**
// **																														**
// ***************************************************************************************************************************
// ***************************************************************************************************************************
