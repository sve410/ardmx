...
//Defines
	//Botones
		#define Up_Boton 51;
		#define Down_Boton 45;
		#define Left_Boton 53;
		#define Right_Boton 49;
		#define Center_Boton 47;
...
void loop()
	{
		Init_LCD();            //inicializador de LCD
		Init_EEPROM_Options(); //Opciones iniciales de eeprom  
		Control_Options();     //Opciones iniciales de control multi y unit   
